/**   
 * @Title: LabProcedureAttrAction.java 
...
/** 
 * @ClassName: LabProcedureAttrAction 
 * @Description: 技工间工序属性Action 
 * @author ERIC
 * @date 2014-6-11 下午02:10:17 
 *  
 */
@Controller
@RequestMapping("/labProcedureAttrAction")
public class LabProcedureAttrAction extends BaseAction {
	...
	public void addData(HttpServletRequest request,HttpServletResponse response){
		LabProcedureAttr labProcedure = new LabProcedureAttr();
