...
/** 
 * @ClassName: CaseLogAction 
 * @Description: 案例日志Action
 * @author ERIC
 * @date 2014-6-11 下午02:10:17 
 *  
 */
@Controller
@RequestMapping("/caseLogAction")
public class CaseLogAction extends BaseAction {
	...
	public void addData(HttpServletRequest request,HttpServletResponse response){
		...
		DXObject.setValue(caseLog, request);
