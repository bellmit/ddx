/**   
 * @Title: ProcedureSubCategoryAction.java 
...
/** 
 * @ClassName: ProcedureSubCategoryAction 
 * @Description: 工序子类别Action
 * @author ERIC
 * @date 2014-6-11 下午02:10:17 
 *  
 */
@Controller
@RequestMapping("/proSubCategoryAction")
public class ProcedureSubCategoryAction extends BaseAction {
