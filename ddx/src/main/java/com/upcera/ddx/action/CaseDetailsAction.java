...
/** 
 * @ClassName: CaseDetailsAction 
 * @Description: 案例详细工作要求Action 
 * @author ERIC
 * @date 2014-6-11 下午02:10:17 
 *  
 */
@Controller
@RequestMapping("/caseDetailsAction")
public class CaseDetailsAction extends BaseAction {
	...
	public void addData(HttpServletRequest request,HttpServletResponse response){
		...
		DXObject.setValue(caseDetails, request);
