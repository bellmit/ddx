...
import com.upcera.ddx.common.barcode.BarCode;

// Referenced classes of package com.mask.util.barcode:
//            BarCode
@Controller
@RequestMapping("/barCode")
public class BarCodeController extends BaseAction {
	...
	public void imgCreate(HttpServletRequest httpservletrequest, HttpServletResponse httpservletresponse) throws ServletException,
			IOException {
