...
<div class="center">
<!--工厂实验室会员中心开始-->
<jsp:include page="../u_lab/center-requestAccount.jsp"></jsp:include>
<!--工厂实验室会员中心结束-->
</div>
<!--中间结束-->
<!--底部开始-->
...
<script type="text/javascript">
	$(function(){
		$("#add-user-a").attr("onclick","showAddPracticeUserDialog();");
...
<div style="display: none;background-color: #FFFFFF" id="add-practice-user-div">
	<jsp:include page="../u_lab/u_lab_Setting_UserEdit_div.jsp?url=practiceAction/addUser.do?operation=requestAccount&id=${requestAccountLab.id}" />
</div>
</html>
