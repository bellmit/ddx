...
<div class="Patients_b_middle_b_left">显示从${datas.onHoldPm.frist }到${datas.onHoldPm.last },共${datas.onHoldPm.total }个</div>
<div class="Patients_b_middle_right">
<c:choose>
	<c:when test="${datas.onHoldPm.offset==datas.onHoldPm.totalPage and datas.onHoldPm.offset==1}">
		...
		<c:otherwise>
			<c:choose>
				<c:when test="${datas.onHoldPm.offset<=datas.onHoldPm.totalPage and datas.onHoldPm.offset>1}">
				<span><a href="javascript:void(0)" onclick="queryCasesList(${datas.onHoldPm.offset-1},'onHold');"><img src="${pageContext.request.contextPath}/jsp/u_lab/images/up.jpg"/></a></span>
				</c:when>
				<c:otherwise>
				<span><a href="javascript:void(0)"><img src="${pageContext.request.contextPath}/jsp/u_lab/images/u_lab10_07.jpg"/></a></span>
				</c:otherwise>
			...
			<c:choose>
				<c:when test="${datas.onHoldPm.offset<datas.onHoldPm.totalPage}">
				<span><a href="javascript:void(0)" onclick="queryCasesList(${datas.onHoldPm.offset+1},'onHold');"><img src="${pageContext.request.contextPath}/jsp/u_lab/images/next.jpg"/></a></span>
				</c:when>
				<c:otherwise>
...
<c:forEach items="${datas.onHoldPm.datas}" var="cases" varStatus="i">
	<c:choose>
