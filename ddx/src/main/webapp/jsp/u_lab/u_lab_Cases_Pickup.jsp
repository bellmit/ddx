...
<div class="practiceCasesPickup_a">申请上门取件服务</div>
...
<div class="practiceCasesPickup_b_middle_right"><i class="Addonecuowu_b">取件日期不能为空</i></span></div>
</li>
<li>
...
<div class="practiceCasesPickup_b_middle_right"><span class="practiceCasesPickup_b_middle_e"><a href="javascript:void(0)" onclick="pickup();">请求</a></span></div>
</li>
</ul>
</form>
</div>
...
<div class="practiceCasesPickup_a">可取件时间</div>
<div class="practiceCasesPickup_b">
<div class="practiceCasesPickup_b_top"></div>
<div class="practiceCasesPickup_b_middle">
...
<span>
<c:choose>
	<c:when test="${lab.sunOpen eq 1 }">
		${lab.sunFrom } ~ ${lab.sunTo }
	</c:when>
	<c:otherwise>
		关闭	
	</c:otherwise>
...
<span>
<c:choose>
	<c:when test="${lab.monOpen eq 1 }">
		${lab.monFrom } ~ ${lab.monTo }
	</c:when>
	<c:otherwise>
		关闭	
	</c:otherwise>
...
<span>
<c:choose>
	<c:when test="${lab.tueOpen eq 1 }">
		${lab.tueFrom } ~ ${lab.tueTo }
	</c:when>
	<c:otherwise>
		关闭	
	</c:otherwise>
...
<span>
<c:choose>
	<c:when test="${lab.wedOpen eq 1 }">
		${lab.wedFrom } ~ ${lab.wedTo }
	</c:when>
	<c:otherwise>
		关闭	
	</c:otherwise>
...
<span>
<c:choose>
	<c:when test="${lab.thuOpen eq 1 }">
		${lab.thuFrom } ~ ${lab.thuTo }
	</c:when>
	<c:otherwise>
		关闭	
	</c:otherwise>
...
<span>
<c:choose>
	<c:when test="${lab.friOpen eq 1 }">
		${lab.friFrom } ~ ${lab.friTo }
	</c:when>
	<c:otherwise>
		关闭	
	</c:otherwise>
...
<span>
<c:choose>
	<c:when test="${lab.satOpen eq 1 }">
		${lab.satFrom } ~ ${lab.satTo }
	</c:when>
	<c:otherwise>
		关闭	
	</c:otherwise>
...
<table width="610" border="0" class="box_edithourscontenttable">
  ...
  <tr>
	...
	<td><input name="mon" id="hours_from_mon" value="${practice.monFrom }" <c:if test="${practice.monOpen ne 1 }"> disabled = "disabled" </c:if> type="text" class="hour_range" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'H:mm'})"/></td>
	<td><input name="tue" id="hours_from_tue" value="${practice.tueFrom }" <c:if test="${practice.tueOpen ne 1 }"> disabled = "disabled" </c:if> type="text" class="hour_range" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'H:mm'})"/></td>
	<td><input name="wed" id="hours_from_wed" value="${practice.wedFrom }" <c:if test="${practice.wedOpen ne 1 }"> disabled = "disabled" </c:if> type="text" class="hour_range" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'H:mm'})"/></td>
	<td><input name="thu" id="hours_from_thu" value="${practice.thuFrom }" <c:if test="${practice.thuOpen ne 1 }"> disabled = "disabled" </c:if> type="text" class="hour_range" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'H:mm'})"/></td>
	<td><input name="fri" id="hours_from_fri" value="${practice.friFrom }" <c:if test="${practice.friOpen ne 1 }"> disabled = "disabled" </c:if> type="text" class="hour_range" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'H:mm'})"/></td>
	<td><input name="sat" id="hours_from_sat" value="${practice.satFrom }" <c:if test="${practice.satOpen ne 1 }"> disabled = "disabled" </c:if> type="text" class="hour_range" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'H:mm'})"/></td>
  </tr>
  <tr>
	...
	<td><input name="mon" id="hours_to_mon" value="${practice.monTo }" <c:if test="${practice.monOpen ne 1 }"> disabled = "disabled" </c:if> type="text" class="hour_range" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'H:mm'})"/></td>
	<td><input name="tue" id="hours_to_tue" value="${practice.tueTo }" <c:if test="${practice.tueOpen ne 1 }"> disabled = "disabled" </c:if> type="text" class="hour_range" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'H:mm'})"/></td>
	<td><input name="wed" id="hours_to_wed" value="${practice.wedTo }" <c:if test="${practice.wedOpen ne 1 }"> disabled = "disabled" </c:if> type="text" class="hour_range" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'H:mm'})"/></td>
	<td><input name="thu" id="hours_to_thu" value="${practice.thuTo }" <c:if test="${practice.thuOpen ne 1 }"> disabled = "disabled" </c:if> type="text" class="hour_range" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'H:mm'})"/></td>
	<td><input name="fri" id="hours_to_fri" value="${practice.friTo }" <c:if test="${practice.friOpen ne 1 }"> disabled = "disabled" </c:if> type="text" class="hour_range" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'H:mm'})"/></td>
	<td><input name="sat" id="hours_to_sat" value="${practice.satTo }" <c:if test="${practice.satOpen ne 1 }"> disabled = "disabled" </c:if> type="text" class="hour_range" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'H:mm'})"/></td>
  </tr>
