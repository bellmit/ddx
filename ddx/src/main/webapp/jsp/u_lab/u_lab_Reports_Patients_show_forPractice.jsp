...
<div class="Settings_Practices_middle_a_leftsearch">
	...
	<div class="Settings_Practices_middle_a_leftsearch02">
		...
		<a href="javascript:void(0)"><img src="${pageContext.request.contextPath}/jsp/u_lab/images/u_lab_07.jpg" onclick="listPatientsByPractice('1','search')"/>
		</a>
	</div>
</div>
<!-- 索搜框结束-->
...
<c:choose>
	<c:when test="${datas.offset==datas.totalPage and datas.offset==1}">
		...
		<c:otherwise>
			<c:choose>
				<c:when test="${datas.offset<=datas.totalPage and datas.offset>1}">
				<span><a href="javascript:void(0)" onclick="listPatientsByPractice(${datas.offset-1},'page');"><img src="${pageContext.request.contextPath}/jsp/u_lab/images/up.jpg"/></a></span>
				</c:when>
				<c:otherwise>
				<span><a href="javascript:void(0)"><img src="${pageContext.request.contextPath}/jsp/u_lab/images/u_lab10_07.jpg"/></a></span>
				</c:otherwise>
			...
			<c:choose>
				...
				<span><a href="javascript:void(0)" onclick="listPatientsByPractice(${datas.offset+1},'page');"><img src="${pageContext.request.contextPath}/jsp/u_lab/images/next.jpg"/></a></span>
				</c:when>
				<c:otherwise>
