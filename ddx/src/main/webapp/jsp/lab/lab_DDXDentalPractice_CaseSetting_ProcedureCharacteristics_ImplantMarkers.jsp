...
<div class="Cases_bottom_right_a">种植导板价目表</div>
<div class="Cases_bottom_right_aa">用于外科手术指导</div>
...
<div class="Settings_Practices_middle_a_leftsearch">
	...
	<div class="Settings_Practices_middle_a_leftsearch02">
		...
		<a href="javascript:void(0)"><img src="${pageContext.request.contextPath}/jsp/u_lab/images/u_lab_07.jpg" onclick="listCharacter('1','implantMarkers')"/>
		</a>
	</div>
</div>
<!-- 搜索框结束-->
...
<ul>
<li class="LabCaseSettingCoupons_b"><a href="javascript:void(0)" onclick="showImplantMarkerDialog('','','','',0)">增加</a></li>
</ul>
</div>
</div>
...
<c:choose>
	...
	<span><a href="javascript:void(0)"><img src="${pageContext.request.contextPath}/jsp/u_lab/images/u_lab11_09.jpg"></a></span>
			...
			<c:otherwise>
				<c:choose>
					<c:when test="${datas.pm.offset<=datas.pm.totalPage and datas.pm.offset>1}">
					<span><a href="javascript:void(0)" onclick="listCharacter(${datas.pm.offset-1},'implantMarkers');"><img src="${pageContext.request.contextPath}/jsp/u_lab/images/up.jpg"/></a></span>
					</c:when>
					<c:otherwise>
					<span><a href="javascript:void(0)"><img src="${pageContext.request.contextPath}/jsp/u_lab/images/u_lab10_07.jpg"/></a></span>
					</c:otherwise>
				...
				<c:choose>
					...
					<span><a href="javascript:void(0)" onclick="listCharacter(${datas.pm.offset+1},'implantMarkers');"><img src="${pageContext.request.contextPath}/jsp/u_lab/images/next.jpg"/></a></span>
					</c:when>
					<c:otherwise>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 ...
 <c:forEach items="${datas.pm.datas}" var="implantMarker">
  <tr>
    <td>
    	${implantMarker.characterName }
    </td>
    <td class="General_RemakeTypes">
    <div class="LabDetails_f_e">
    <div class="LabDetails_f_e_left">
    	<a href="javascript:void(0)" onclick="showImplantMarkerDialog('${implantMarker.id}','${implantMarker.characterName}','${implantMarker.defaultPrice }','${implantMarker.taxable }',1)">修改</a>
    </div>
    	...
    	<!--小菜单下拉开始-->
		   <ol class="menu_all">
		     ...
		     <li class="menu_bgdelete">
		     	<a href="javascript:void(0)" onclick="delCharacter('delImplantMarker','${implantMarker.id}')">删除</a>
		     </li>
...
<div id="add_edit_implantMarker_div" style="display: none;">
