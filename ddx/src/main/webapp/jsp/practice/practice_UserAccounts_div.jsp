...
<div class="Settings_Practices_middle_a_leftsearch">
	...
	<div class="Settings_Practices_middle_a_leftsearch02">
		...
		<a href="javascript:void(0)"><img src="${pageContext.request.contextPath}/jsp/u_lab/images/u_lab_07.jpg" onclick="listPracticeUsers('1')"/>
		</a>
	</div>
</div>
<!-- 索搜框结束-->
...
<ul>
<li class="UserAccounts"><a href="javascript:void(0)" onclick="showAddPracticeUserDialog();">增加</a></li>
</ul>
</div>
</div>
...
<div class="Settings_Practices_middle_b_right">
	<c:choose>
		...
		<c:otherwise>
			<c:choose>
				<c:when test="${pm.offset<=pm.totalPage and pm.offset>1}">
				<span><a href="javascript:void(0)" onclick="listPracticeUsers(${pm.offset-1});"><img src="${pageContext.request.contextPath}/jsp/u_lab/images/up.jpg"/></a></span>
				</c:when>
				<c:otherwise>
				<span><a href="javascript:void(0)"><img src="${pageContext.request.contextPath}/jsp/u_lab/images/u_lab10_07.jpg"/></a></span>
				</c:otherwise>
			...
			<c:choose>
				...
				<span><a href="javascript:void(0)" onclick="listPracticeUsers(${pm.offset+1});"><img src="${pageContext.request.contextPath}/jsp/u_lab/images/next.jpg"/></a></span>
				</c:when>
				<c:otherwise>
			...
			<c:choose>
				<c:when test="${user.isMain=='true' }">
					   <td class="UserAccounts_a">
					   		<a href="${pageContext.request.contextPath }/practiceAction/getUser.do?userId=${user.accountId}">编辑</a>
					   </td>
				</c:when>
				<c:otherwise>
					    <td class="General_RemakeTypes">
						    ...
						    -->
						    <div class="LabDetails_f_e">
							    <div class="LabDetails_f_e_left"><a href="${pageContext.request.contextPath }/practiceAction/getUser.do?userId=${user.accountId}">编辑</a></div>
							    <div class="LabDetails_f_e_right">
							    	 <!--小菜单下拉开始-->
									   <ol class="menu_all">
									     <li class="first">
									     ...
									     <li class="menu_bgrighttop"><img src="${pageContext.request.contextPath}/jsp/box/images/menu_bg077.jpg" width="160" height="4" /></li>
											<li class="menu_bgdelete"><a href="javascript:void(0)" onclick="deletePracticeUser(${user.accountId});">删除</a></li>
