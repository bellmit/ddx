...
<div class="Cases_bottom_right_a">种植系统价目表</div>
...
<div class="Settings_Practices_middle_a_leftsearch">
	...
	<div class="Settings_Practices_middle_a_leftsearch02">
		...
		<a href="javascript:void(0)"><img src="${pageContext.request.contextPath}/jsp/u_lab/images/u_lab_07.jpg" onclick="listCharacter('1','implantSystems')"/>
		</a>
	</div>
</div>
<!-- 搜索框结束-->
...
<ul>
<li class="LabCaseSettingCoupons_b"><a href="javascript:void(0)" onclick="showImplantSystemDialog('','','','','',0)">增加</a></li>
</ul>
</div>
</div>
...
<c:choose>
	...
	<span><a href="javascript:void(0)"><img src="${pageContext.request.contextPath}/jsp/u_lab/images/u_lab11_09.jpg"></a></span>
			...
			<c:otherwise>
				<c:choose>
					<c:when test="${datas.pm.offset<=datas.pm.totalPage and datas.pm.offset>1}">
					<span><a href="javascript:void(0)" onclick="listCharacter(${datas.pm.offset-1},'implantSystems');"><img src="${pageContext.request.contextPath}/jsp/u_lab/images/up.jpg"/></a></span>
					</c:when>
					<c:otherwise>
					<span><a href="javascript:void(0)"><img src="${pageContext.request.contextPath}/jsp/u_lab/images/u_lab10_07.jpg"/></a></span>
					</c:otherwise>
				...
				<c:choose>
					...
					<span><a href="javascript:void(0)" onclick="listCharacter(${datas.pm.offset+1},'implantSystems');"><img src="${pageContext.request.contextPath}/jsp/u_lab/images/next.jpg"/></a></span>
					</c:when>
					<c:otherwise>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 ...
 <c:forEach items="${datas.pm.datas}" var="implantSystem">
  <tr>
    <td>
    	${implantSystem.characterName }
    </td>
    <td>${implantSystem.classfication }</td>
    <td class="General_RemakeTypes">
    <div class="LabDetails_f_e">
    <div class="LabDetails_f_e_left">
    	<a href="javascript:void(0)" onclick="showImplantSystemDialog('${implantSystem.id}','${implantSystem.characterName}','${implantSystem.classfication}','${implantSystem.defaultPrice }','${implantSystem.taxable }',1)">修改</a>
    </div>
    	...
    	<!--小菜单下拉开始-->
		   <ol class="menu_all">
		     ...
		     <li class="menu_bgdelete">
		     	<a href="javascript:void(0)" onclick="delCharacter('delImplantSystem','${implantSystem.id}')">删除</a>
		     </li>
...
<div id="add_edit_implantSystem_div" style="display: none;">
...
<input name="" id="name" type="text" maxlength="30" class="Personalize_b_middle_b"/>
</div>
</li>
...
<li>
<div class="Personalize_b_middle_left"><span>类别</span><span class="Personalize_b_middle_a">*</span></div>
<div class="Personalize_b_middle_right">
<select name="classfication" id="classfication" size="1">
	<option label="Nobel Biocare" value="Nobel Biocare">Nobel Biocare</option>
	<option label="Straumann" value="Straumann">Straumann</option>
	<option label="Zimmer" value="Zimmer">Zimmer</option>
	<option label="Implant Direct" value="Implant Direct">Implant Direct</option>
	<option label="Ankylos" value="Ankylos">Ankylos</option>
	<option label="Camlog" value="Camlog">Camlog</option>
	<option label="Astra Tech" value="Astra Tech">Astra Tech</option>
	<option label="3I Biomet" value="3I Biomet">3I Biomet</option>
...
<div class="Personalize_b_middle_right"><input name="" id="defaultPrice" maxlength="10" type="text" class="Personalize_b_middle_b"/></div>
</li>
...
<div class="Personalize_b_middle_right"><input name="" id="taxable" type="checkbox" value="" /></div>
</li>
</ul>
</form>
</div>
